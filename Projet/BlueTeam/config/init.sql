...
('admin', 'admin@admin.com', MD5('adminpass'), 'admin'); -- 1

-- Ajout des utilisateurs (élèves et professeurs)
INSERT INTO users (username, email, password, role) VALUES
('barthur', 'arthur.berret@edu.ece.fr', MD5('password123'), 'eleve'), -- 2
('djules', 'jules.dias@edu.ece.fr', MD5('password123'), 'eleve'), -- 3
('dtheophile', 'theophile.dutrey@edu.ece.fr', MD5('password123'), 'eleve'), -- 4
('ralexis', 'alexis.raynal@edu.ece.fr', MD5('password123'), 'eleve'),   -- 5
('gmathis', 'mathis.gras@edu.ece.fr', MD5('password123'), 'eleve'), -- 6
('mlefevre', 'm.lefevre@mail.com', MD5('password123'), 'prof'),   -- 7
('vmorel', 'v.morel@mail.com', MD5('password123'), 'prof'),  -- 8
('btajini', 'b.tajini@mail.com', MD5('password123'), 'prof');  -- 9
...
(2, 'Cyb Grp 2', 'Mathematiques', '2025-03-26 14:00:00', 'Salle 202'),
